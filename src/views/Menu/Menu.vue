<template>
  <div>
    ...
    >
      <el-table-column prop="id" label="菜单编号" sortable width="250">
      </el-table-column>

      <el-table-column prop="title" label="菜单名称" sortable width="250">
      </el-table-column>

      <el-table-column prop="icon" label="菜单图标" sortable width="250">
      </el-table-column>

      <el-table-column prop="url" label="菜单地址" sortable width="250">
      </el-table-column>
